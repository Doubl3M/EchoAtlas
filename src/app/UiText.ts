...
export const uiText = Object.freeze({
    ...
    timelineHelp: "Explorer l’Atlas à cette date",
    timelineRangeLabel: "Choisir une période de l’Atlas",
    timelineLatest: "Présent de l’Atlas",
    timelineEmpty: "Aucune écoute historique",
    timelineMonths: Object.freeze([
        "janv.",
        "févr.",
        "mars",
        "avr.",
